...
| **Fleet ops** (projects, branches, snapshots, restore, org transfer)      | **Control-plane API**                          | Examples in `[examples/api-scripts](../examples/api-scripts/)`: create/delete project, branch, **snapshot + restore** (`[versioning-flow.mjs](../examples/api-scripts/versioning-flow.mjs)`), transfer.                                                                                                                                                  |
