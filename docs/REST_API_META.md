...
| **Fleet ops** (projects, branches, snapshots, org transfer) | **Control-plane API** | Examples in [`examples/api-scripts`](../examples/api-scripts/) (create/delete project, branch, snapshot, transfer). |
