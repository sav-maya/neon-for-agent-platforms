...
**Partners cloning the repo:** follow **[README, Quick start](https://github.com/neondatabase/neon-for-agent-platforms/blob/main/README.md#quick-start)** (repository root), **[references/README.md](https://github.com/neondatabase/neon-for-agent-platforms/blob/main/skills/neon-postgres-agent-platforms/references/README.md)** (reading order + symlink index), and **[MANAGEMENT_API_SAMPLES.md](https://github.com/neondatabase/neon-for-agent-platforms/blob/main/skills/neon-postgres-agent-platforms/references/MANAGEMENT_API_SAMPLES.md)** for scripts and env vars. This file is for **assistants** (after `**neon-postgres`**); it does not replace that skill.
...
The repository **[README.md](https://github.com/neondatabase/neon-for-agent-platforms/blob/main/README.md)** (**Quick start**) is the human entry point. **`references/README.md`** lists **reading order** for deeper docs and symlinked **`*.ts`**. **All** runnable scripts live under **`scripts/`** at the repo root; **`references/`** mirrors each **`*.ts`** as a symlink for skill-local browsing.
