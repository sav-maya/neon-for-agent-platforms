...
**Partners cloning the repo:** follow **[README, Start here](https://github.com/neondatabase/neon-for-agent-platforms/blob/main/README.md#start-here-agent-program-partners)** (repository root), **[references/README.md](https://github.com/neondatabase/neon-for-agent-platforms/blob/main/skills/neon-postgres-agent-platforms/references/README.md)** (index), and **[MANAGEMENT_API_SAMPLES.md](https://github.com/neondatabase/neon-for-agent-platforms/blob/main/skills/neon-postgres-agent-platforms/references/MANAGEMENT_API_SAMPLES.md)** for scripts and env vars. This file is for **assistants** (after `**neon-postgres`**); it does not replace that skill.
...
The repository **[README.md](https://github.com/neondatabase/neon-for-agent-platforms/blob/main/README.md)** (**Install the companion skill** and **Example scripts**) is the human entry point. **All** runnable scripts live under **`scripts/`** at the repo root; **`references/`** mirrors each **`*.ts`** as a symlink for skill-local browsing.

- **[Fleet and org model](https://github.com/neondatabase/neon-for-agent-platforms/blob/main/README.md#fleet-and-org-model-summary)**: two-org mental model mapped to scripts.
...
- **[Compound checkpoints for agent platforms](https://github.com/neondatabase/neon-for-agent-platforms/blob/main/skills/neon-postgres-agent-platforms/references/COMPOUND_CHECKPOINTS_FOR_AGENT_PLATFORMS.md)**: what to store besides Neon ids (revision, secrets, deploy, metadata).
